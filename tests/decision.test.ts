...
const result = (score: number, completeness = 80, target = 1150): StockAnalysisResult => ({
  ...
  comprehensiveAnalysis: { score, dataCompleteness: completeness, confidence: completeness, label: 'Positif', horizon: 'Swing 5–20 hari', generatedAt: '', warnings: [], components: [
