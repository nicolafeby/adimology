import { jakartaDate } from '../../lib/point-in-time';
import { guardScreenerRequest } from '../../lib/screener-api';
import { runUnifiedScreener } from '../../lib/unified-screener-service';
...
export default async (request: Request) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({ success: false, error: 'Screening background gagal.' }), { status: 500, headers: { 'content-type': 'application/json' } });
  }
};
